...
function storyToRow(s) {
  return {
    ...
    video_caption: s.videoCaption || null,
...
function rowToAnnouncement(r) {
  return {
    ...
    title: r.title || '',
    eventStart: r.event_start || null,  // ISO timestamp or null (evergreen notice)
    eventEnd: r.event_end || null,
    place: r.place || '',
    address: r.address || '',
    lat: r.lat, lng: r.lng,
    ...
    imageCreditUrl: r.image_credit_url || '',
    showImageCredit: r.show_image_credit !== false,
...
function announcementToRow(a) {
  return {
    ...
    image_credit_url: a.imageCreditUrl || null,
    show_image_credit: a.showImageCredit !== false,
    image_position: a.imagePosition || null,
