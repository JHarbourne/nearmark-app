...
const simBtn = { position: 'absolute', bottom: 'calc(104px + env(safe-area-inset-bottom))', left: '50%', transform: 'translateX(-50%)', zIndex: 30, height: '48px', padding: '0 22px', display: 'flex', alignItems: 'center', gap: '10px', borderRadius: '24px', background: 'var(--overlay-panel)', backdropFilter: 'blur(14px)', border: '1px solid var(--line)', boxShadow: '0 10px 30px rgba(0,0,0,0.5)', cursor: 'pointer', color: 'var(--ink)', fontFamily: "var(--font-button)", fontWeight: 600, fontSize: '15px', whiteSpace: 'nowrap' }
const nav = { position: 'absolute', bottom: 0, left: 0, right: 0, zIndex: 35, height: 'calc(84px + env(safe-area-inset-bottom))', paddingBottom: 'calc(18px + env(safe-area-inset-bottom))', display: 'flex', alignItems: 'center', background: 'var(--overlay-nav)', backdropFilter: 'blur(16px)', borderTop: '1px solid var(--line)' }
