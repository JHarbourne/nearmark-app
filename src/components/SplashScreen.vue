...
const wrap = { position: 'absolute', inset: 0, padding: '64px 26px max(30px, env(safe-area-inset-bottom))', display: 'flex', flexDirection: 'column', overflowY: 'auto', WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain' }
const cta = {
