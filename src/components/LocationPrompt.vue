...
<template>
  <div style="position: absolute; inset: 0; z-index: 80;">
    ...
    <div :style="sheet" role="dialog" aria-modal="true" aria-label="Enable location">
      ...
      <span :style="iconWrap">
        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 21 C 8 16, 5 12.5 5 9 a7 7 0 0 1 14 0 C 19 12.5 16 16 12 21 Z" fill="#fff"/><circle cx="12" cy="9" r="2.6" fill="#17111f"/></svg>
      </span>
      <h2 style="font-family: 'Bricolage Grotesque'; font-weight: 700; font-size: 22px; margin: 16px 0 8px; text-align: center;">{{ title }}</h2>
      <p style="font-family: 'Newsreader'; font-size: 15.5px; line-height: 1.55; color: #D9CFE0; margin: 0 auto 22px; max-width: 300px; text-align: center;">{{ body }}</p>
...
const iconWrap = {
  ...
  background: 'linear-gradient(135deg, #9B6DFF, #FF4D5E)', alignItems: 'center', justifyContent: 'center',
}
const cta = {
